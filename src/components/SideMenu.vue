    ...
    <aside class=" bg-background px-10 py-8 h-screen sticky left-0 top-0">
        ...
        <nav class="my-8 grid gap-y-4">
            <template v-if="pages.prof == 'student'">
                <div class="c1">
                    <SideBtn :prof="prof" :pageLink="thePages[0].pageRoute" :title="thePages[0].pageTitle" :isActive="thePages[0].pageTitle == isActivePage ? true : false" icon="analytics" />
                    <SideBtn :prof="prof" pageLink="/mycourses" :activePage="isActivePage" :title="thePages[1].pageTitle" :isActive="true" icon="book-outline" :isDropDown="true" :list="thePages[1].subPages"/>
                </div>
                <SideBtn :prof="prof" :pageLink="thePages[2].pageRoute" :title="thePages[2].pageTitle" :isActive="thePages[2].pageTitle == isActivePage ? true : false" icon="card-outline"/>
                <SideBtn :prof="prof" :pageLink="thePages[3].pageRoute" :title="thePages[3].pageTitle" :isActive="thePages[3].pageTitle == isActivePage ? true : false" icon="trash-bin-outline"/>
                <div class="c2">
                    <SideBtn :prof="prof" :pageLink="thePages[4].pageRoute" :title="thePages[4].pageTitle" :isActive="false" icon="information-circle-outline"/>
                    <SideBtn :prof="prof" :pageLink="thePages[5].pageRoute" :title="thePages[5].pageTitle" :isActive="false" icon="settings-outline"/>
                    <SideBtn :prof="prof" :pageLink="thePages[6].pageRoute" :title="thePages[6].pageTitle" :isActive="false" icon="log-out-outline"/>
                </div> 
            </template>
            <template v-if="pages.prof == 'instructor'">
                <div class="c1">
                    ...
                    <SideBtn :prof="prof" pageLink="/mycourses" :activePage="isActivePage" :title="thePages[1].pageTitle" :isActive="thePages[1].pageTitle ==isActivePage ? true : false" :isDropDown="true" :list="thePages[1].subPages" :icon="thePages[1].pageIcon"/>
                </div>
            ...
            <template v-if="pages.prof == 'admin'">
                ...
                <div class="c2">
                    ...
                    <SideBtn :prof="prof" :pageLink="thePages[6].pageRoute" :title="thePages[6].pageTitle" :isActive="thePages[6].pageTitle ==isActivePage ? true : false" :icon="thePages[6].pageIcon"/>
                    <SideBtn :prof="prof" :pageLink="thePages[7].pageRoute" :title="thePages[7].pageTitle" :isActive="thePages[7].pageTitle ==isActivePage ? true : false" :icon="thePages[7].pageIcon"/>
                    <SideBtn :prof="prof" :pageLink="thePages[8].pageRoute" :title="thePages[8].pageTitle" :isActive="thePages[8].pageTitle ==isActivePage ? true : false" :icon="thePages[8].pageIcon"/>
                </div>
            </template>
        </nav>
    </aside>
