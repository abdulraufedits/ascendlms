<template>
    ...
    <section class="pt-12 pb-12 sm:pb-16 lg:pt-16">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col gap-y-32">
            <div class="flex flex-col max-w-lg mx-auto lg:max-w-full lg:gap-y-12 lg:gap-x-16">
                <div>
                    <div class="text-center lg:text-left flex flex-col gap-4 items-start w-3/4">
                        <h1 class="text-4xl font-big font-bold leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:leading-tight lg:text-8xl font-pj">Your All-in-One Learning Solution.</h1>
            ...
            <div class="simple-section">
                ...
                <div class="grid grid-cols-16 grid-rows-4 w-full gap-4">
                    ...
                    <Widget class="col-span-6 row-span-4 row-start-3 !block">
                        <h1>Manage widgets</h1>
                        <p class="subtitle">lorem ipsum</p>
                    </Widget>
                </div>
            ...
            <div class="simple-section">
                ...
                <p class="subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vehicula massa in enim luctus. Rutrum arcu.</p>
                <div class="flex gap-x-4 w-full items-center justify-between">
    ...
    <section>
        <div class="testimonials">
                ...
                <div class="flex">
                    <img src="https://api.dicebear.com/9.x/adventurer/svg?seed=Angel" alt="author">
                    <span>
            ...
            <div class=" py-32 flex justify-center items-center ">
                <div class="px-24 !py-20 bg-primary rounded-2xl simple-section">
                    <h1 class="text-5xl text-white">Manage your institution like never before</h1>
                <p class="text-white font-small">Get started today with 10,000 free slots.</p>
                <div class="ctas font-small font-medium flex gap-x-4">
    ...
    <section class="py-10 bg-gray-50 sm:pt-16 lg:pt-24 font-small">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <div class="flex gap-x-4 items-center">
                    <img class="w-auto h-9" src="../assets/logo.svg" alt="logo" />
                    <h1 class="h1-title">Ascend LMS</h1>
                </div>
            ...
            <div>
                <p class="text-lg font-big  text-gray-400 ">Company</p>
            ...
            <div>
                <p class="text-lg font-big  text-gray-400 ">Help</p>
        ...
        <p class="text-sm text-center text-gray-600">Ascend LMS © Copyright 2024, All Rights Reserved</p>
    </div>
</section>
