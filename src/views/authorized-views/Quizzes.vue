<template>
    <div class="flex">
        ...
        <main class="w-full">
            <StudentHeader :username="user.username" @close-side-bar="()=> sideBarState = sideBarState ? false : true" subtitle="Courses / Quizzes"/>
            ...
            <QuizzesTable :quizzes="courses.sort(sortType,courses.courses, 'quizzes')"/>
        </main>
    </div>
